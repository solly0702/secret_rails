...
RSpec.describe "dispaying likes" do
  before do
    @user = create_user
    log_in @user
  ...
  it "display unlike button for secrets already liked" do
    visit "/secrets"
  ...
  it "deletes like and displays the channges in both profile and secrets page" do
    visit "/secrets"
    click_button "Unlike"
